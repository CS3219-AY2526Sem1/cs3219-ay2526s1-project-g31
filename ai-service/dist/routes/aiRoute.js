...
router.post("/explain", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const conversationContext = history.map((msg) => `User: ${msg.user}\nAI: ${msg.ai}`).join("\n\n");
...
`;
    const response = yield callOllama("mistral", fullPrompt);
    const newHistory = [
        ...history,
...
router.post("/hint", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { question, code, prompt, session_id, numPrompts } = req.body;
    const key = session_id || "default";
    const history = memoryStore.get(key) || [];
    if (numPrompts <= 0) {
...
router.post("/testcases", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { question, code, prompt, session_id, numPrompts } = req.body;
    const key = session_id || "default";
    const history = memoryStore.get(key) || [];
    if (numPrompts <= 0) {
...
router.post("/debug", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { question, code, prompt, session_id, numPrompts } = req.body;
    const key = session_id || "default";
    const history = memoryStore.get(key) || [];
    if (numPrompts <= 0) {
...
router.post("/refactor", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { question, code, prompt, session_id, numPrompts } = req.body;
    const key = session_id || "default";
    const history = memoryStore.get(key) || [];
    if (numPrompts <= 0) {
